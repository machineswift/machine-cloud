package com.machine.dragon.server.ops.gateway.config;

import com.machine.dragon.server.ops.gateway.property.DragonAuthProperties;
...
@Slf4j
@Configuration
@EnableConfigurationProperties({DragonAuthProperties.class})
public class DragonCorsConfiguration {
