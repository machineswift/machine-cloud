package com.machine.dragon.common.tool.file;

import com.machine.dragon.common.tool.exception.Exceptions;
import com.machine.dragon.common.tool.string.CharPool;
...
public class FileUtil extends org.springframework.util.FileCopyUtils {
	...
	public static String getFileExtension(String fullName) {
		if (DragonStringUtil.isBlank(fullName)) return StringPool.EMPTY;
