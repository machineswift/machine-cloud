...
import com.machine.dragon.common.tool.bean.DragonBeanUtil;
import com.machine.dragon.common.tool.bean.DragonClassUtil;
import com.machine.dragon.common.tool.collection.DragonCollectionUtil;
import com.machine.dragon.common.tool.convert.DragonConvertUtil;
import com.machine.dragon.common.tool.date.ConcurrentDateFormat;
import com.machine.dragon.common.tool.date.DragonDateTimeUtil;
import com.machine.dragon.common.tool.date.DragonDateUtil;
import com.machine.dragon.common.tool.file.FileUtil;
import com.machine.dragon.common.tool.jackson.DragonJsonUtil;
import com.machine.dragon.common.tool.number.DragonNumberUtil;
import com.machine.dragon.common.tool.object.DragonObjectUtil;
import com.machine.dragon.common.tool.random.RandomType;
import com.machine.dragon.common.tool.secret.Base64Util;
import com.machine.dragon.common.tool.secret.DigestUtil;
import com.machine.dragon.common.tool.file.IoUtil;
...
import com.machine.dragon.common.tool.url.DragonUrlUtil;
...
public class DragonFunction {
	...
	public static String firstCharToLower(String str) {
		return DragonStringUtil.firstCharToLower(str);
	}
	...
	public static String firstCharToUpper(String str) {
		return DragonStringUtil.firstCharToUpper(str);
	}
	...
	public static boolean isBlank(@Nullable final CharSequence cs) {
		return DragonStringUtil.isBlank(cs);
	}
	...
	public static boolean isNotBlank(@Nullable final CharSequence cs) {
		return DragonStringUtil.isNotBlank(cs);
	}
	...
	public static boolean isAnyBlank(final CharSequence... css) {
		return DragonStringUtil.isAnyBlank(css);
	}
	...
	public static boolean isNoneBlank(final CharSequence... css) {
		return DragonStringUtil.isNoneBlank(css);
	}
	...
	public static boolean isArray(@Nullable Object obj) {
		return DragonObjectUtil.isArray(obj);
	}
	...
	public static boolean isEmpty(@Nullable Object[] array) {
		return DragonObjectUtil.isEmpty(array);
	}
	...
	public static boolean isNotEmpty(@Nullable Object[] array) {
		return DragonObjectUtil.isNotEmpty(array);
	}
	...
	public static String format(@Nullable String message, @Nullable Map<String, ?> params) {
		return DragonStringUtil.format(message, params);
	}
	...
	public static String format(@Nullable String message, @Nullable Object... arguments) {
		return DragonStringUtil.format(message, arguments);
	}
	...
	public static String format(long nanos) {
		return DragonStringUtil.format(nanos);
	}
	...
	public static boolean equalsSafe(@Nullable Object o1, @Nullable Object o2) {
		return DragonObjectUtil.nullSafeEquals(o1, o2);
	}
	...
	public static <T> boolean contains(@Nullable T[] array, final T element) {
		return DragonCollectionUtil.contains(array, element);
	}
	...
	public static boolean contains(@Nullable Iterator<?> iterator, Object element) {
		return DragonCollectionUtil.contains(iterator, element);
	}
	...
	public static boolean contains(@Nullable Enumeration<?> enumeration, Object element) {
		return DragonCollectionUtil.contains(enumeration, element);
	}
	...
	public static <E> Set<E> ofImmutableSet(E... es) {
		return DragonCollectionUtil.ofImmutableSet(es);
	}
	...
	public static <E> List<E> ofImmutableList(E... es) {
		return DragonCollectionUtil.ofImmutableList(es);
	}
	...
	public static boolean isNumeric(final CharSequence cs) {
		return DragonStringUtil.isNumeric(cs);
	}
	...
	public static int toInt(final Object str) {
		return DragonNumberUtil.toInt(String.valueOf(str));
	}
	...
	public static int toInt(@Nullable final Object str, final int defaultValue) {
		return DragonNumberUtil.toInt(String.valueOf(str), defaultValue);
	}
	...
	public static long toLong(final Object str) {
		return DragonNumberUtil.toLong(String.valueOf(str));
	}
	...
	public static long toLong(@Nullable final Object str, final long defaultValue) {
		return DragonNumberUtil.toLong(String.valueOf(str), defaultValue);
	}
	...
	public static Double toDouble(Object value, Double defaultValue) {
		return DragonNumberUtil.toDouble(String.valueOf(value), defaultValue);
	}
	...
	public static Float toFloat(Object value, Float defaultValue) {
		return DragonNumberUtil.toFloat(String.valueOf(value), defaultValue);
	}
	...
	public static Integer[] toIntArray(String split, String str) {
		if (DragonStringUtil.isEmpty(str)) {
			return new Integer[]{};
		}
	...
	public static String to62String(long num) {
		return DragonNumberUtil.to62String(num);
	}
	...
	public static String join(Collection<?> coll) {
		return DragonStringUtil.join(coll);
	}
	...
	public static String join(Collection<?> coll, String delim) {
		return DragonStringUtil.join(coll, delim);
	}
	...
	public static String join(Object[] arr) {
		return DragonStringUtil.join(arr);
	}
	...
	public static String join(Object[] arr, String delim) {
		return DragonStringUtil.join(arr, delim);
	}
	...
	public static List<String> split(CharSequence str, char separator) {
		return DragonStringUtil.split(str, separator, -1);
	}
	...
	public static List<String> splitTrim(CharSequence str, char separator) {
		return DragonStringUtil.splitTrim(str, separator);
	}
	...
	public static String[] split(@Nullable String str, @Nullable String delimiter) {
		return DragonStringUtil.delimitedListToStringArray(str, delimiter);
	}
	...
	public static String randomUUID() {
		return DragonStringUtil.randomUUID();
	}
	...
	public static String escapeHtml(String html) {
		return DragonStringUtil.escapeHtml(html);
	}
	...
	public static String random(int count) {
		return DragonStringUtil.random(count);
	}
	...
	public static String random(int count, RandomType randomType) {
		return DragonStringUtil.random(count, randomType);
	}
	...
	public static String toJson(Object object) {
		return DragonJsonUtil.toJson(object);
	}
	...
	public static byte[] toJsonAsBytes(Object object) {
		return DragonJsonUtil.toJsonAsBytes(object);
	}
	...
	public static JsonNode readTree(String jsonString) {
		return DragonJsonUtil.readTree(jsonString);
	}
	...
	public static JsonNode readTree(InputStream in) {
		return DragonJsonUtil.readTree(in);
	}
	...
	public static JsonNode readTree(byte[] content) {
		return DragonJsonUtil.readTree(content);
	}
	...
	public static JsonNode readTree(JsonParser jsonParser) {
		return DragonJsonUtil.readTree(jsonParser);
	}
	...
	public static <T> T readJson(byte[] bytes, Class<T> valueType) {
		return DragonJsonUtil.parse(bytes, valueType);
	}
	...
	public static <T> T readJson(String jsonString, Class<T> valueType) {
		return DragonJsonUtil.parse(jsonString, valueType);
	}
	...
	public static <T> T readJson(InputStream in, Class<T> valueType) {
		return DragonJsonUtil.parse(in, valueType);
	}
	...
	public static <T> T readJson(byte[] bytes, TypeReference<T> typeReference) {
		return DragonJsonUtil.parse(bytes, typeReference);
	}
	...
	public static <T> T readJson(String jsonString, TypeReference<T> typeReference) {
		return DragonJsonUtil.parse(jsonString, typeReference);
	}
	...
	public static <T> T readJson(InputStream in, TypeReference<T> typeReference) {
		return DragonJsonUtil.parse(in, typeReference);
	}
	...
	public static String urlEncode(String source, Charset charset) {
		return DragonUrlUtil.encode(source, charset);
	}
	...
	public static String formatDateTime(Date date) {
		return DragonDateUtil.formatDateTime(date);
	}
	...
	public static String formatDate(Date date) {
		return DragonDateUtil.formatDate(date);
	}
	...
	public static String formatTime(Date date) {
		return DragonDateUtil.formatTime(date);
	}
	...
	public static String format(Object object, String pattern) {
		if (object instanceof Number) {
			...
			return DragonDateUtil.format((Date) object, pattern);
		} else if (object instanceof TemporalAccessor) {
			return DragonDateUtil.format((TemporalAccessor) object, pattern);
		}
	...
	public static Date parseDate(String dateStr, String pattern) {
		return DragonDateUtil.parse(dateStr, pattern);
	}
	...
	public static Date parse(String dateStr, ConcurrentDateFormat format) {
		return DragonDateUtil.parse(dateStr, format);
	}
	...
	public static String formatDateTime(TemporalAccessor temporal) {
		return DragonDateTimeUtil.formatDateTime(temporal);
	}
	...
	public static String formatDate(TemporalAccessor temporal) {
		return DragonDateTimeUtil.formatDate(temporal);
	}
	...
	public static String formatTime(TemporalAccessor temporal) {
		return DragonDateTimeUtil.formatTime(temporal);
	}
	...
	public static LocalDateTime parseDateTime(String dateStr) {
		return DragonDateTimeUtil.parseDateTime(dateStr);
	}
	...
	public static LocalTime parseTime(String dateStr) {
		return DragonDateTimeUtil.parseTime(dateStr);
	}
	...
	public static Duration between(Date startDate, Date endDate) {
		return DragonDateUtil.between(startDate, endDate);
	}
	...
	public static <T> T convert(@Nullable Object source, Class<T> targetType) {
		return DragonConvertUtil.convert(source, targetType);
	}
	...
	public static <T> T convert(@Nullable Object source, TypeDescriptor sourceType, TypeDescriptor targetType) {
		return DragonConvertUtil.convert(source, sourceType, targetType);
	}
	...
	public static MethodParameter getMethodParameter(Constructor<?> constructor, int parameterIndex) {
		return DragonClassUtil.getMethodParameter(constructor, parameterIndex);
	}
	...
	public static MethodParameter getMethodParameter(Method method, int parameterIndex) {
		return DragonClassUtil.getMethodParameter(method, parameterIndex);
	}
	...
	public static <A extends Annotation> A getAnnotation(Method method, Class<A> annotationType) {
		return DragonClassUtil.getAnnotation(method, annotationType);
	}
	...
	public static <A extends Annotation> A getAnnotation(HandlerMethod handlerMethod, Class<A> annotationType) {
		return DragonClassUtil.getAnnotation(handlerMethod, annotationType);
	}
	...
	public static <T> T newInstance(Class<?> clazz) {
		return (T) DragonBeanUtil.instantiateClass(clazz);
	}
	...
	public static <T> T newInstance(String clazzStr) {
		return DragonBeanUtil.newInstance(clazzStr);
	}
	...
	public static Object getProperty(@Nullable Object bean, String propertyName) {
		return DragonBeanUtil.getProperty(bean, propertyName);
	}
	...
	public static void setProperty(Object bean, String propertyName, Object value) {
		DragonBeanUtil.setProperty(bean, propertyName, value);
	}
	...
	public static <T> T clone(@Nullable T source) {
		return DragonBeanUtil.clone(source);
	}
	...
	public static <T> T copy(@Nullable Object source, Class<T> clazz) {
		return DragonBeanUtil.copy(source, clazz);
	}
	...
	public static void copy(@Nullable Object source, @Nullable Object targetBean) {
		DragonBeanUtil.copy(source, targetBean);
	}
	...
	public static void copyNonNull(@Nullable Object source, @Nullable Object targetBean) {
		DragonBeanUtil.copyNonNull(source, targetBean);
	}
	...
	public static <T> T copyWithConvert(@Nullable Object source, Class<T> clazz) {
		return DragonBeanUtil.copyWithConvert(source, clazz);
	}
	...
	public static <T> List<T> copy(@Nullable Collection<?> sourceList, Class<T> targetClazz) {
		return DragonBeanUtil.copy(sourceList, targetClazz);
	}
	...
	public static <T> List<T> copyWithConvert(@Nullable Collection<?> sourceList, Class<T> targetClazz) {
		return DragonBeanUtil.copyWithConvert(sourceList, targetClazz);
	}
	...
	public static <T> T copyProperties(@Nullable Object source, Class<T> clazz) throws BeansException {
		return DragonBeanUtil.copyProperties(source, clazz);
	}
	...
	public static <T> List<T> copyProperties(@Nullable Collection<?> sourceList, Class<T> targetClazz) throws BeansException {
		return DragonBeanUtil.copyProperties(sourceList, targetClazz);
	}
	...
	public static Map<String, Object> toMap(@Nullable Object bean) {
		return DragonBeanUtil.toMap(bean);
	}
	...
	public static <T> T toBean(Map<String, Object> beanMap, Class<T> valueType) {
		return DragonBeanUtil.toBean(beanMap, valueType);
	}
