...
public class DragonConvertUtil {
	...
	public static <T> T convert(@Nullable Object source, Class<T> targetType) {
		...
		if (DragonClassUtil.isAssignableValue(targetType, source)) {
			return (T) source;
		}
		GenericConversionService conversionService = DragonConversionService.getInstance();
