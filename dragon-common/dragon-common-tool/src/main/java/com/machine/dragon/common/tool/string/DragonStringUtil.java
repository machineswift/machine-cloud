 ...
 */
public class DragonStringUtil extends StringUtils {
	...
	public static boolean isBlank(final CharSequence cs) {
		return !DragonStringUtil.hasText(cs);
	}
	...
	public static boolean isAnyBlank(final CharSequence... css) {
		if (DragonObjectUtil.isEmpty(css)) {
			return true;
		}
		return Stream.of(css).anyMatch(DragonStringUtil::isBlank);
	}
	...
	public static boolean isNoneBlank(final CharSequence... css) {
		...
		return Stream.of(css).allMatch(DragonStringUtil::isNotBlank);
	}
	...
	public static boolean isAllBlank(final CharSequence... css) {
		return Stream.of(css).allMatch(DragonStringUtil::isBlank);
	}
	...
	public static String format(@Nullable String message, @Nullable Map<String, ?> params) {
		...
		for (int start, end; (start = message.indexOf(StringPool.DOLLAR_LEFT_BRACE, cursor)) != -1 && (end = message.indexOf(StringPool.RIGHT_BRACE, start)) != -1; ) {
			...
			Object value = params.get(DragonStringUtil.trimWhitespace(key));
	...
	public static String join(Collection<?> coll) {
		return DragonStringUtil.collectionToCommaDelimitedString(coll);
	}
	...
	public static String join(Collection<?> coll, String delim) {
		return DragonStringUtil.collectionToDelimitedString(coll, delim);
	}
	...
	public static String join(Object[] arr) {
		return DragonStringUtil.arrayToCommaDelimitedString(arr);
	}
	...
	public static String join(Object[] arr, String delim) {
		return DragonStringUtil.arrayToDelimitedString(arr, delim);
	}
	...
	public static String escapeHtml(String html) {
		return DragonStringUtil.isBlank(html) ? StringPool.EMPTY : HtmlUtils.htmlEscape(html);
	}
	...
	public static String random(int count) {
		return DragonStringUtil.random(count, RandomType.ALL);
	}
	...
	public static String random(int count, RandomType randomType) {
		...
		final Random random = DragonHolder.SECURE_RANDOM;
