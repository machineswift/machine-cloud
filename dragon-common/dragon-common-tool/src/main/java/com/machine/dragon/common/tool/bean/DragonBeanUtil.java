...
import com.machine.dragon.common.tool.convert.DragonConverter;
 ...
 * 实体工具类
 */
public class DragonBeanUtil extends org.springframework.beans.BeanUtils {
	...
	public static <T> T newInstance(String clazzStr) {
		try {
			Class<?> clazz = DragonClassUtil.forName(clazzStr, null);
	...
	public static <T> T clone(@Nullable T source) {
		...
		return (T) DragonBeanUtil.copy(source, source.getClass());
	}
	...
	public static <T> T copy(@Nullable Object source, Class<T> clazz) {
		...
		return DragonBeanUtil.copy(source, source.getClass(), clazz);
	}
	...
	public static <T> T copy(@Nullable Object source, Class sourceClazz, Class<T> targetClazz) {
		...
		DragonBeanCopier copier = DragonBeanCopier.create(sourceClazz, targetClazz, false);
	...
	public static <T> List<T> copy(@Nullable Collection<?> sourceList, Class<T> targetClazz) {
		...
		for (Object source : sourceList) {
			...
			T bean = DragonBeanUtil.copy(source, sourceClazz, targetClazz);
			outList.add(bean);
		}
		return outList;
	}
	...
	public static void copy(@Nullable Object source, @Nullable Object targetBean) {
		...
		DragonBeanCopier copier = DragonBeanCopier
	...
	public static <T> T copyWithConvert(@Nullable Object source, Class<T> targetClazz) {
		...
		return DragonBeanUtil.copyWithConvert(source, source.getClass(), targetClazz);
	}
	...
	public static <T> T copyWithConvert(@Nullable Object source, Class<?> sourceClazz, Class<T> targetClazz) {
		...
		DragonBeanCopier copier = DragonBeanCopier.create(sourceClazz, targetClazz, true);
		T to = newInstance(targetClazz);
		copier.copy(source, to, new DragonConverter(sourceClazz, targetClazz));
		return to;
	}
	...
	public static <T> List<T> copyWithConvert(@Nullable Collection<?> sourceList, Class<T> targetClazz) {
		...
		for (Object source : sourceList) {
			...
			T bean = DragonBeanUtil.copyWithConvert(source, sourceClazz, targetClazz);
			outList.add(bean);
		}
		return outList;
	}
	...
	public static <T> T copyProperties(@Nullable Object source, Class<T> targetClazz) throws BeansException {
		...
		T to = newInstance(targetClazz);
		DragonBeanUtil.copyProperties(source, to);
		return to;
	}
	...
	public static <T> List<T> copyProperties(@Nullable Collection<?> sourceList, Class<T> targetClazz) throws BeansException {
		...
		for (Object source : sourceList) {
			...
			T bean = DragonBeanUtil.copyProperties(source, targetClazz);
			outList.add(bean);
		}
		return outList;
	}
	...
	public static Map<String, Object> toMap(@Nullable Object bean) {
		...
		return DragonBeanMap.create(bean);
	}
	...
	public static <T> T toBean(Map<String, Object> beanMap, Class<T> valueType) {
		...
		DragonBeanUtil.copy(beanMap, to);
		return to;
	}
	...
	public static Object generator(@Nullable Object superBean, BeanProperty... props) {
		...
		DragonBeanUtil.copy(superBean, genBean);
		return genBean;
	}
