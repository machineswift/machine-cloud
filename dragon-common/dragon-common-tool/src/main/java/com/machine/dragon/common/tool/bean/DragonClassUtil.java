 ...
 * 类操作工具
 */
public class DragonClassUtil extends org.springframework.util.ClassUtils {
	...
	public static <A extends Annotation> A getAnnotation(Method method, Class<A> annotationType) {
		...
		Method specificMethod = DragonClassUtil.getMostSpecificMethod(method, targetClass);
