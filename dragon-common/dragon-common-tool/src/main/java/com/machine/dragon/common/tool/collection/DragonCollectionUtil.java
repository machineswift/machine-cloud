package com.machine.dragon.common.tool.collection;
 ...
 * 集合工具类
 */
public class DragonCollectionUtil extends CollectionUtils {
	...
	public static <T> boolean contains(@Nullable T[] array, final T element) {
		...
		return Arrays.stream(array).anyMatch(x -> DragonObjectUtil.nullSafeEquals(x, element));
	}
