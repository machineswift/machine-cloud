package com.machine.dragon.common.launch.property;
 ...
 */
@Slf4j
public class DragonPropertySourcePostProcessor implements BeanFactoryPostProcessor, InitializingBean, Ordered {
	private final ResourceLoader resourceLoader;
	private final List<PropertySourceLoader> propertySourceLoaders;

	public DragonPropertySourcePostProcessor() {
	...
	public void postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory) throws BeansException {
		Map<String, Object> beansWithAnnotation = beanFactory.getBeansWithAnnotation(DragonPropertySource.class);
		...
		for (Map.Entry<String, Object> entry : beanEntrySet) {
			...
			DragonPropertySource propertySource = AnnotationUtils.getAnnotation(beanClass, DragonPropertySource.class);
	...
	private static void loadPropertySource(String location, Resource resource,
		...
		if (resource.exists()) {
			String name = "dragonPropertySource: [" + location + "]";
			try {
